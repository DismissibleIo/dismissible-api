...
ENV DISMISSIBLE_STORAGE_RUN_SETUP=true
ENV DISMISSIBLE_STORAGE_TYPE="memory"

# Memory Storage
ENV DISMISSIBLE_STORAGE_MEMORY_MAX_ITEMS=5000
ENV DISMISSIBLE_STORAGE_MEMORY_TTL_MS=21600000
...
# Cache Configuration
ENV DISMISSIBLE_CACHE_TYPE=""

# Memory Cache
ENV DISMISSIBLE_CACHE_MEMORY_MAX_ITEMS=""
ENV DISMISSIBLE_CACHE_MEMORY_TTL_MS=""

# Redis Cache
ENV DISMISSIBLE_CACHE_REDIS_URL=""
ENV DISMISSIBLE_CACHE_REDIS_KEY_PREFIX=""
ENV DISMISSIBLE_CACHE_REDIS_TTL_MS=""
ENV DISMISSIBLE_CACHE_REDIS_ENABLE_READY_CHECK=""
ENV DISMISSIBLE_CACHE_REDIS_MAX_RETRIES=""
ENV DISMISSIBLE_CACHE_REDIS_CONNECTION_TIMEOUT_MS=""
...
# CORS
ENV DISMISSIBLE_CORS_ENABLED=false
...
# Rate Limiter
ENV DISMISSIBLE_RATE_LIMITER_ENABLED=false
ENV DISMISSIBLE_RATE_LIMITER_POINTS=1000
ENV DISMISSIBLE_RATE_LIMITER_DURATION=1
ENV DISMISSIBLE_RATE_LIMITER_BLOCK_DURATION=60
ENV DISMISSIBLE_RATE_LIMITER_KEY_TYPE="ip,origin,referrer"
ENV DISMISSIBLE_RATE_LIMITER_KEY_MODE="any"
ENV DISMISSIBLE_RATE_LIMITER_IGNORED_KEYS=""
ENV DISMISSIBLE_RATE_LIMITER_PRIORITY=-101
