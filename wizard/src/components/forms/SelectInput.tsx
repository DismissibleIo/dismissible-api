      ...
      >
        <Listbox value={value} onChange={onChange}>
          <div className="relative">
            ...
            <Listbox.Options className="absolute z-[100] mt-2 max-h-60 w-full overflow-auto rounded-lg bg-[#0a0f1e] border border-white/10 py-1 shadow-2xl backdrop-blur-xl focus:outline-none">
